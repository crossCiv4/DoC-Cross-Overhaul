...
minor_cities = [
	...
	MinorCity(-2200, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=1, iCiv=iPhoenicia, units={iDefend: 2}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1600, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=1, iCiv=iPhoenicia, units={iDefend: 2, iShock: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1100, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=1, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1000, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=1, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
