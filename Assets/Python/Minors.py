...
minor_cities = [
	...
	MinorCity(-2200, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1600, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iShock: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1115, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1050, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
