...
minor_cities = [
	...
	MinorCity(-1600, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iShock: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1125, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1050, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 2, iCounter: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
