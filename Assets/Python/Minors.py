...
minor_cities = [
	...
	MinorCity(820, iBarbarian, (70, 65), "Szczecin", iPopulation=2, iCiv=iPoland, units={iAttack: 2, iSkirmish: 2, iDefend: 2}, buildings=[iWalls, iMonument], adjective="TXT_KEY_ADJECTIVE_POMERANIAN"),
