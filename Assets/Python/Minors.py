...
minor_cities = [
	MinorCity(-2900, iIndependent2, tSusa, "Shushan", iPopulation=1, iCiv=iBabylonia, units={iDefend: 2}, adjective="TXT_KEY_ADJECTIVE_ELAMITE"),
	...
	MinorCity(-2200, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 1}, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1900, iIndependent, (79, 53), "Wilusha", iPopulation=1, iCiv=iHittites, units={iCounter: 1, iDefend: 1}, condition=lambda: player(iHittites).isHuman() or player(iMinoans).isHuman() or player(iBabylonia).isHuman() or player(iAssyria).isHuman() or player(iEgypt).isHuman(), adjective="TXT_KEY_ADJECTIVE_ASSUWAN"),
	MinorCity(-1600, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 1, iShock: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1115, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 1, iCounter: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	MinorCity(-1050, iBarbarian, tJerusalem, "Yerushalayim", iPopulation=2, iCiv=iPhoenicia, units={iDefend: 1, iCounter: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ISRAELITE"),
	...
	MinorCity(-1200, iBarbarian, (89, 53), "Tushpa", iPopulation=2, iCiv=iHittites, units={iDefend: 3}, adjective="TXT_KEY_ADJECTIVE_ARMENIAN"),
	MinorCity(-900, iIndependent, (89, 53), "Tushpa", iPopulation=2, iCiv=iHittites, units={iDefend: 2, iCounter: 2}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_ARMENIAN"),
	...
	MinorCity(-910, iIndependent2, (79, 52), "Sfard", iPopulation=2, iCiv=iHittites, units={iDefend: 1, iCounter: 1}, condition=lambda: not player(iHittites).isHuman(), adjective="TXT_KEY_ADJECTIVE_LYDIAN"),
	...
	MinorCity(-800, iIndependent2, tMecca, "Yathrib", iPopulation=1, iCiv=iArabia, units={iHarass: 1, iDefend: 1}, adjective="TXT_KEY_CIV_ARABIA_ADJECTIVE"),
	MinorCity(-800, iIndependent2, tTrebizond, "Trapezous", iPopulation=2, iCiv=iGreece, units={iDefend: 1}, condition=lambda: player(iGreece).isExisting() and not player(iGreece).isHuman(),  adjective="TXT_KEY_CIV_GREECE_ADJECTIVE"),
	...
	MinorCity(-600, iIndependent, (97, 53), "Margu", iPopulation=2, iCiv=iPersia, units={iDefend: 1}, adjective="TXT_KEY_ADJECTIVE_SOGDIAN"),
	...
	MinorCity(-650, iIndependent, tPella, "Aigai", iPopulation=2, iCiv=iDorians, units={iDefend: 1, iCounter:1, iWork: 1}, adjective="TXT_KEY_CIV_MACEDON_ADJECTIVE"), 
	...
	MinorCity(-510, iIndependent2, (68, 53), "Roma", iPopulation=3, iCiv=iRome, units={iCounter: 2, iWork: 1}, adjective="TXT_KEY_CIV_ROME_ADJECTIVE"),
	...
	MinorCity(800, iBarbarian, (69, 56), "Venesia", iPopulation=5, iCiv=iItaly, units={iDefend: 3}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_VENETIAN"),
	MinorCity(410, iBarbarian, (54, 54), "Bracara", iPopulation=2, iCiv=iSaxons, units={iDefend: 1, iAttack: 2, iSkirmish: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_GERMANIC"),
	MinorCity(700, iBarbarian, (54, 54), "Bracara", iPopulation=2, iCiv=iSaxons, units={iDefend: 1, iAttack: 2, iSkirmish: 1}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_GERMANIC"),
	MinorCity(500, iBarbarian, (68, 75), u"Nidaróss", iPopulation=2, iCiv=iSaxons, units={iDefend: 1}, adjective="TXT_KEY_ADJECTIVE_GERMANIC"),
	MinorCity(570, iBarbarian, (72, 59), "Vindomina", iPopulation=2, iCiv=iBulgaria, units={iHarass: 5}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_AVAR"),
	MinorCity(610, iIndependent, (96, 40), "Masqat", iPopulation=2, iCiv=iParthia, units={iDefend: 2}, adjective="TXT_KEY_CIV_ARABIA_ADJECTIVE"),
	MinorCity(730, iBarbarian, (70, 61), "Praha", iPopulation=2, iCiv=iCelts, units={iDefend: 1, iCounter: 2}, adjective="TXT_KEY_ADJECTIVE_SLAVIC"),
	...
	MinorCity(1000, iBarbarian, (73, 65), "Gdansk", iPopulation=2, iCiv=iPoland, units={iSkirmish: 1}, buildings=[iHarbor], adjective="TXT_KEY_ADJECTIVE_POMERANIAN"),
	MinorCity(1000, iBarbarian, (92, 66), "Qazan", iPopulation=2, iCiv=iBulgaria, units={iHarass: 2}, adjective="TXT_KEY_ADJECTIVE_BULGAR"),
	MinorCity(950, iBarbarian, (78, 65), "Voruta", iPopulation=2, iCiv=iPoland, units={iHarass: 3, iDefend: 1, iAttack: 2}, adjective="TXT_KEY_ADJECTIVE_LITHUANIAN"),
	#MinorCity(1000, iNative, (67, 34), "Kano", iPopulation=2, iCiv=iMali, units={iDefend: 2}, adjective="TXT_KEY_ADJECTIVE_HAUSA"),
	MinorCity(1060, iBarbarian, (57, 44), "Merrakesh", iPopulation=2, units={iSkirmish: 1, iCounter: 1}, adjective="TXT_KEY_ADJECTIVE_ALMORAVID"),
	MinorCity(1100, iIndependent, (144, 33), "Nan Madol", iPopulation=1),
	MinorCity(1150, iNative, (15, 44), "Ts'intsuntsani", iPopulation=3, iCiv=iToltecs, units={iDefend: 1, iAttack: 2}, bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_PUREPECHA"),
	...
	MinorCity(1350, iIndependent, (91, 55), "Quba", iPopulation=2, iCiv=iTurks, units={iHarass: 1}, iCulture=30, buildings=[iMonument, iHarbor], bIgnoreRuins=True, adjective="TXT_KEY_ADJECTIVE_TURKIC"),
...
barbarians = [
	...
	Barbarians(-1750, -1300, {iChariot: 1}, ((85, 50), (91, 57)), 8, MINORS, adjective="TXT_KEY_ADJECTIVE_HURRIAN"),
	...
	Barbarians(-650, -300, {iSpearman: 2}, ((71, 54), (73, 58)), 8, INVADERS, target_area=((73, 49), (77, 54)), adjective="TXT_KEY_ADJECTIVE_ILLYRIAN"),
	Barbarians(-650, -300, {iLightSwordsman: 1}, ((54, 50), (58, 54)), 10, INVADERS, target_area=((54, 48), (62, 54)), adjective="TXT_KEY_ADJECTIVE_CELTIBERIAN"),
	Barbarians(-300, -70, {iLightSwordsman: 1, iSkirmisher: 1}, ((54, 50), (58, 54)), 7, INVADERS, target_area=((54, 48), (62, 54)), adjective="TXT_KEY_ADJECTIVE_CELTIBERIAN"),
	...
	Barbarians(-250, 150, {iCamelRider: 3}, ((87, 34),  (94, 40)), 8, NOMADS,adjective="TXT_KEY_CIV_YEMEN_HIMYAR_ADJECTIVE"),
	...
	Barbarians(100, 450, {iSwordsman: 3, iAxeman: 2}, ((64, 59), (75, 65)), 3, INVADERS, target_area=((59, 55), (62, 53)), adjective="TXT_KEY_ADJECTIVE_GERMANIC"),
	...
	Barbarians(175, 205, {iLightSwordsman: 2, iSwordsman: 1, iSkirmisher: 1, iCatapult: 1}, ((123, 50), (127, 55)), 1, CLOSE_INVADERS, target_area=((121, 49), (127, 53)), adjective="TXT_KEY_ADJECTIVE_YELLOW_TURBAN"),
	Barbarians(500, 600, {iSwordsman: 2, iSkirmisher: 1}, ((101, 37), (112, 45)), 8, MINORS, adjective="TXT_KEY_ADJECTIVE_HINDI"),
	Barbarians(300, 550, {iPatiyodha: 2, iSkirmisher: 2, iLightSwordsman: 2}, ((101, 37), (111, 41)), 8, INVADERS, target_area=((103, 32), (108, 37)), adjective="TXT_KEY_ADJECTIVE_KALABHRA"),
	Barbarians(600, 820, {iPatiyodha: 3, iWarElephant: 1, iSwordsman: 2}, ((101, 37), (111, 41)), 8, INVADERS, target_area=((103, 32), (108, 37)), adjective="TXT_KEY_ADJECTIVE_PALLAVA"),
	...
	Barbarians(300, 550, {iCamelRider: 2}, ((86, 38), (91, 45)), 7, NOMADS, target_area=((77, 39), (91, 50)), adjective="TXT_KEY_ADJECTIVE_BEDOUIN"),
	Barbarians(550, 620, {iCamelArcher: 3}, ((86, 38), (91, 45)), 3, NOMADS, target_area=((77, 39), (91, 50)), adjective="TXT_KEY_ADJECTIVE_BEDOUIN"),
	Barbarians(800, 1500, {iCamelArcher: 1}, ((86, 38), (91, 45)), 8, NOMADS, target_area=((77, 39), (91, 50)), adjective="TXT_KEY_ADJECTIVE_BEDOUIN"),
	Barbarians(330, 380, {iFrankishAxeman: 4, iCatapult: 1}, ((59, 59), (65, 65)), 3, INVADERS, target_area=((59, 55), (62, 53)), iAlternativeCiv=iFranks, adjective="TXT_KEY_ADJECTIVE_FRANKISH"),
	...
	Barbarians(540, 600, {iSwordsman: 2, iAxeman: 2, iCatapult: 1}, ((70, 58), (72, 61)), 3, INVADERS, target_area=((67, 50), (71, 53)), adjective="TXT_KEY_CIV_ITALY_LOMBARD"),	
	Barbarians(540, 600, {iOghuz: 4}, ((78, 57), (80, 62)), 4, INVADERS, target_area=((65, 52), (72, 59)), adjective="TXT_KEY_ADJECTIVE_AVAR", promotions=(iMobility,)),
	Barbarians(510, 610, {iLightSwordsman: 1, iSkirmisher: 1, iAxeman: 1}, ((68, 60), (77, 65)), 6, INVADERS, target_area=((74, 49), (76, 52)), iAlternativeCiv=iBulgaria, adjective="TXT_KEY_ADJECTIVE_SLAVIC"),
	Barbarians(610, 850, {iSwordsman: 2, iSkirmisher: 1, iAxeman: 1}, ((71, 61), (77, 65)), 8, INVADERS, target_area=((62, 55), (64, 70)), adjective="TXT_KEY_ADJECTIVE_SLAVIC"),
	...
	Barbarians(560, 610, {iKonnik: 3}, ((78, 57), (82, 62)), 3, NOMADS, target_area=((74, 52), (79, 56)), iAlternativeCiv=iBulgaria, adjective="TXT_KEY_ADJECTIVE_BULGAR", promotions=(iMobility,)),
	...
	Barbarians(900, 1180, {iKeshik: 3, iOghuz: 3}, ((115, 55), (127, 64)), 3, INVADERS, target_area=((117, 46), (129, 59)), adjective="TXT_KEY_ADJECTIVE_KHITAN", promotions=(iDesertAdaptation, iSteppeAdaptation)),
	...
	Barbarians(1100, 1250, {iMamlukCavalry: 3, iHorseArcher: 4}, ((82, 60), (105, 63)), 5, NOMADS, target_area=((76, 56), (91, 61)), adjective="TXT_KEY_ADJECTIVE_CUMAN"),
